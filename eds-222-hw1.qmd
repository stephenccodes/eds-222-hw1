...
The population in this setting is the population of the entire city in question, Lahore, Pakistan over the given time frame.

2.  What are the *samples* in this setting? Please be precise.

The samples are measurements of airborne particulate matter in different geographic locations across Lahore, Pakistan, taken both by the government and crowd-sourced individuals 

The locations where the samples were taken are observations, and the crowd-sourced and government data as a whole are two samples of the entire population of Lahore from 11/4/18 to 11/30/19.
...
dtaa being computed by citizens who had expertise collecting this type of datat, 2 daata collected by wealthy who may be living in an area with better air quality. and 3 samples being ocllected at different periods of time and frequency because the sampling mehtods are not standardized
...
Given that we know about the sampling bias, yes, the data from the government that indicates lower levels of pollution than the crowd-sourced dataset is as expected.
